export default function DataCard({ title, icon, value, onClick }) {
  return (
    <div
      onClick={onClick}
      className="p-4 bg-gradient-to-t from-white via-[#6DD5FA] to-[#2980B9] rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 space-y-10 py-8 min-w-[250px] h-max"
    >
