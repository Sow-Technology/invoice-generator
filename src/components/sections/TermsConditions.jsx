    ...
    <div className="flex flex-col gap-5 text-[10px] leading-3 ">
      ...
      <ol className="list-decimal ml-7 ">
        <li>
          ...
          come with a 1-year unconditional warranty. This warranty covers any
          accidental damage from the customer&#39;s end, and we will replace the
          frame free of cost.{" "}
          <li>
            <b>Warranty on Lenses 1.60 Lenses:</b> Covered under the
            unconditional warranty. If they break, we will replace them free of
            cost. Other Lenses: Not covered under the unconditional warranty for
            breakage.
          </li>{" "}
          <li>
            <b>Warranty on Coatings</b> All lenses have a 1-year warranty on
            anti-glare and other similar coatings. If any coating peels off
            within this period, we will replace the lenses free of cost.
          </li>
          <li>
            {" "}
          ...
          <li>
            <b>Returns and Replacements</b> Please note that we do not offer any
